...
$result = mysqli_query($mysqli, "SELECT id, title, picture_link, description, date, price, author, phone FROM posts WHERE author = '".$_SESSION["username"]."'");
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo "You haven't created any post";
}
echo '
</div>
</body>
